...
// ADD BOOK
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookaudor, $semester, $branch, $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookaudor, semester, branch, bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookaudor', '$semester', '$branch', '$bookprice', '$bookquantity','$bookquantity',0)";
...
//REQUEST BOOK
    ...
    function requestbook($userid,$bookid){
        ...
        if($usertype=="student"){
            $days=15;//book request then issue days//
        }
        if($usertype=="teacher"){
            $days=20;
        }
